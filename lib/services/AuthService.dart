...
import 'package:fooddelivery/modules/OTPScreen.dart';
  ...
  try {
    ...
    if (userCredential.user != null) {
      ...
      UserModel userModel = UserModel()
        ...
        ..city = ''
        ..isDeleted = false
        ..oneSignalPlayerId = getStringAsync(PLAYER_ID);

      await userDBService.addDocumentWithCustomId(currentUser.uid, userModel.toJson());
      await signInWithEmail(email: email, password: password);
    } else {
      throw errorSomethingWentWrong;
    }
  } on FirebaseAuthException catch (e) {
    throw e.message ?? errorSomethingWentWrong;
  } catch (e) {
    throw e.toString();
  }
}
