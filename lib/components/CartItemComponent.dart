...
import 'package:fooddelivery/modules/LoginScreen.dart';
...
class CartItemComponent extends StatefulWidget {
  ...
  CartItemComponent({super.key, this.cartData, required this.onUpdate, this.isCartScreen});
      ...
      children: [
        ...
        Column(
          ...
          children: <Widget>[
            ...
            widget.cartData!.categoryName != null ? Text('${appStore.translate('in')} ${widget.cartData!.categoryName}', style: secondaryTextStyle(size: 12)) : SizedBox(),
            4.height,
        ...
        Container(
          ...
          child: Row(
            children: [
              const Icon(Icons.remove, size: 20, color: colorPrimary).paddingSymmetric(horizontal: 8).visible(appStore.mCartList.isNotEmpty).onTap(() {
              ...
              4.width,
              const Icon(Icons.add, size: 20, color: colorPrimary).paddingSymmetric(horizontal: 8).visible(appStore.mCartList.isNotEmpty).onTap(() {
                if (appStore.isLoggedIn) {
