...
mixin _$AppStore on _AppStore, Store {
  ...
  @override
  List<MenuModel?> get mCartList {
    _$mCartListAtom.reportRead();
    return super.mCartList;
  }

  @override
  set mCartList(List<MenuModel?> value) {
  ...
  void setAppLocalization(BuildContext context) {
    final $actionInfo = _$_AppStoreActionController.startAction(
        name: '_AppStore.setAppLocalization');
    try {
      return super.setAppLocalization(context);
    } finally {
      _$_AppStoreActionController.endAction($actionInfo);
    }
  }
